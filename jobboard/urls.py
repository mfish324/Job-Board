...
def robots_txt(request):
    ...
    lines.extend([
        ...
        "Disallow: /recruiter/",
        "",
        "# Split-pane preview fragments — partial HTML with no <head>, duplicating",
        "# content that already has a canonical detail page. Only reached by fetch()",
        "# from /jobs/; nothing links to them.",
